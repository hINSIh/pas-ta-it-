		...
		<tr id="tr_height">
			<td colspan="2" id="iframe_form"><!-- 아이프레임 -->
				...
				<script> function button_click(value){
					if(value==1){
						document.getElementById("iframe_form").innerHTML="<iframe src='login.jsp' width='100%' height='300'></iframe>"
						}else{
						document.getElementById("iframe_form").innerHTML="<iframe src='join.jsp' width='100%' height='300'></iframe>"
					}
				}</script>
			</td>
